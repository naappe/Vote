...
const titles:Record<string,{title:string;eyebrow:string}>={
  ...
  '/voter-management':{title:'Residents',eyebrow:'Residents and field status'},
...
export default function Header(){
  ...
  return <>
    ...
    <nav className="sticky top-16 z-20 flex gap-2 overflow-x-auto border-b border-border bg-card/95 px-3 py-2.5 backdrop-blur lg:hidden" aria-label="Mobile navigation">
      {[
        ['Dashboard','/'],['Residents','/voter-management/'],['Calls','/call-center/'],['Visits','/door-to-door/'],['Verify','/admin-verification/'],['Reports','/reports/']
