...
export default function VoterDetailContent(){
 ...
 if(!id)return <div className="panel text-center"><h1>Select a resident</h1><Link href="/voter-management/" className="btn-primary mt-5">Open residents</Link></div>;
